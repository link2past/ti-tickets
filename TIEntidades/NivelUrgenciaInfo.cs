...
{
    [Serializable]
    public class NivelUrgenciaInfo
    {
        ...
        public NivelUrgenciaInfo()
        {
        }

        public NivelUrgenciaInfo(int? nIdNivelUrgencia, String sDescripcion, int? nIdEstado, EstadoInfo oEstado,
