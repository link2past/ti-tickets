...
namespace TIEntidades
{
    ...
    public class TipoUsuarioInfo
    {
        ...
        public TipoUsuarioInfo()
        {
        }

        public TipoUsuarioInfo(int? nIdTipoUsuario, String sDescripcion, int? nIdEstado, EstadoInfo oEstado, String sUsuarioCreacion, String sUsuarioModificacion)
        {
