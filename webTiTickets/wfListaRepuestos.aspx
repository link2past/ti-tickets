<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfListaRepuestos.aspx.cs" Inherits="webTiTickets.wfListaRepuestos" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>TI Consulting - Listado de Repuestos</title>
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Mantenimientos
                            ...
                            <ul class="dropdown-menu" role="menu">
                                ...
                                <li class="active"><a href="wfListaRepuestos.aspx">Repuestos</a></li>
                ...
                <ContentTemplate>
                    ...
                    <div class="row">
                        <div class="col-xs-2">
                            Id Repuesto:</div>
                        <div class="col-xs-4">
                            <asp:TextBox ID="txtIdRepuesto" CssClass="form-control input-sm" runat="server"></asp:TextBox>
                        </div>
                        <div class="col-xs-2">
                            Descripción:</div>
                        <div class="col-xs-4">
                    ...
                    <div class="row">
                        <div class="btn-group">
                            <asp:Button ID="btnNuevo" runat="server" Text="Nuevo Repuesto" 
