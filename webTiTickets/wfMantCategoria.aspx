<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfMantCategoria.aspx.cs"
    Inherits="webTiTickets.wfMantCategoria" %>
        ...
        <div class="row">
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    <hr />
                    <h2>
                        Mantenimiento de Categorías de Problemas</h2>
                    <hr />
                    <h4>
                        Búsqueda</h4>
                    <div class="row">
                        <div class="col-xs-2">
                            Descripción</div>
                        <div class="col-xs-3">
                            <asp:TextBox ID="txtCategoria" CssClass="form-control input-sm" runat="server"></asp:TextBox>
                    ...
                    <div class="row">
                        <div class="btn-group">
                            <asp:Button ID="btnNuevo" runat="server" Text="Nueva Categoría" CssClass="btn btn-info"
                    ...
                    <hr />
                    <asp:GridView ID="gvCategorias" CssClass="table table-striped table-bordered table-condensed"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Id">
                                <ItemTemplate>
                                    <asp:Label ID="lblIdCategoriaG" runat="server" Text='<%#Eval("IdCategoriaProblema") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
