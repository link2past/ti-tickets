<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfMantEstadoTicket.aspx.cs"
    Inherits="webTiTickets.wfMantEstadoTicket" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>TI Consulting - Mantenimiento de Estados de Tickets</title>
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Mantenimientos
                            ...
                            <ul class="dropdown-menu" role="menu">
                                ...
                                <li class="active"><a href="wfMantEstadoTicket.aspx">Estados de Ticket</a></li>
        ...
        <div class="row">
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    <hr />
                    <h2>
                        Mantenimiento de Estados de Ticket</h2>
                    <hr />
                    <h4>
                        Búsqueda</h4>
                    <div class="row">
                        <div class="col-xs-2">
                            Descripción:</div>
                        <div class="col-xs-3">
                            <asp:TextBox ID="txtEstadoTicket" CssClass="form-control input-sm" runat="server"></asp:TextBox>
                    ...
                    <div class="row">
                        <div class="btn-group">
                            <asp:Button ID="btnNuevo" runat="server" Text="Nuevo Estado" CssClass="btn btn-info"
                    ...
                    <hr />
                    <asp:GridView ID="gvEstadoTicket" CssClass="table table-striped table-bordered table-condensed"
                        AutoGenerateColumns="False" runat="server" OnRowCancelingEdit="gvEstadoTicket_RowCancelingEdit"
                        OnRowDataBound="gvEstadoTicket_RowDataBound" OnRowEditing="gvEstadoTicket_RowEditing"
                        OnRowUpdating="gvEstadoTicket_RowUpdating">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Id">
                                <ItemTemplate>
                                    <asp:Label ID="lblIdEstadoTicketG" runat="server" Text='<%#Eval("IdEstadoTicket") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Descripcion">
                                ...
                                <EditItemTemplate>
                                    <asp:TextBox ID="txtDescripcionG" runat="server" CssClass="form-control input-sm"
