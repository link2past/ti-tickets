<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfMantTipoUsuario.aspx.cs" Inherits="webTiTickets.wfMantTipoUsuario" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>TI Consulting - Mantenimiento de Tipos de Usuario</title>
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Mantenimientos
                            ...
                            <ul class="dropdown-menu" role="menu">
                                ...
                                <li class="active"><a href="wfMantTipoUsuario.aspx">Tipos de Usuario</a></li>
        ...
        <div class="row">
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    <hr />
                    <h2>
                        Mantenimiento de Tipos de Usuario</h2>
                    <hr />
                    <h4>
                        Búsqueda</h4>
                    <div class="row">
                        <div class="col-xs-2">
                            Descripción:</div>
                        <div class="col-xs-3">
                            <asp:TextBox ID="txtTipoUsuario" CssClass="form-control input-sm" runat="server"></asp:TextBox>
                    ...
                    <div class="row">
                        <div class="btn-group">
                            <asp:Button ID="btnNuevo" runat="server" Text="Nuevo Tipo de Usuario" CssClass="btn btn-info"
                    ...
                    <hr />
                    <asp:GridView ID="gvTipoUsuario" CssClass="table table-striped table-bordered table-condensed"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Id">
                                <ItemTemplate>
                                    <asp:Label ID="lblIdTipoUsuarioG" runat="server" Text='<%#Eval("IdTipoUsuario") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
