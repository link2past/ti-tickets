<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfMantUnidadNegocio.aspx.cs" Inherits="webTiTickets.wfMantUnidadNegocio" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>TI Consulting - Mantenimiento de Unidades de Negocio</title>
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Mantenimientos
                            ...
                            <ul class="dropdown-menu" role="menu">
                                ...
                                <li class="active"><a href="wfMantUnidadNegocio.aspx">Unidades de Negocio</a></li>
        ...
        <div class="row">
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    <hr />
                    <h2>
                        Mantenimiento de Unidades de Negocio</h2>
                    <hr />
                    <h4>
                        Búsqueda</h4>
                    <div class="row">
                        <div class="col-xs-2">
                            Descripción:</div>
                        <div class="col-xs-3">
                            <asp:TextBox ID="txtUnidadNegocio" CssClass="form-control input-sm" runat="server"></asp:TextBox>
                    ...
                    <div class="row">
                        <div class="btn-group">
                            <asp:Button ID="btnNuevo" runat="server" Text="Nueva Unidad" CssClass="btn btn-info"
                    ...
                    <hr />
                    <asp:GridView ID="gvUnidadNegocio" CssClass="table table-striped table-bordered table-condensed"
                        AutoGenerateColumns="False" runat="server" 
                        onrowcancelingedit="gvUnidadNegocio_RowCancelingEdit" 
                        onrowdatabound="gvUnidadNegocio_RowDataBound" 
                        onrowediting="gvUnidadNegocio_RowEditing" onrowupdating="gvUnidadNegocio_RowUpdating" 
                        >
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Id">
                                <ItemTemplate>
                                    <asp:Label ID="lblIdUnidadNegocioG" runat="server" Text='<%#Eval("IdUnidadNegocio") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
