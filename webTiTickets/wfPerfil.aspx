<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfPerfil.aspx.cs" Inherits="webTiTickets.wfPerfil" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>TI Consulting - Perfil del Usuario</title>
                ...
                <div class="container">
                    <div class="row">
                        <label class="col-xs-2" for="txtIdUsuario">
                            Usuario</label>
                        <div class="col-xs-4">
                            <asp:TextBox ID="txtIdUsuario" CssClass="form-control input-sm" runat="server" Enabled="False"></asp:TextBox>
                        </div>
                    </div>
                    <p />
                    <div class="row">
                        <label class="col-xs-2" for="txtCliente">
                            Cliente Asociado</label>
                        <div class="col-xs-4">
                            <asp:TextBox ID="txtCliente" CssClass="form-control input-sm" runat="server" Enabled="False"></asp:TextBox>
                        </div>
                    </div>
                    <p />
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-xs-2">
                            <label for="txtNuevaContrasena">
                                Nueva Contraseña</label></div>
                        <div class="col-xs-3">
                            <asp:TextBox ID="txtNuevaContrasena" CssClass="form-control input-sm" runat="server"
