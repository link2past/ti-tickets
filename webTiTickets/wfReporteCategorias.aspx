<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfReporteCategorias.aspx.cs"
    Inherits="webTiTickets.wfReporteCategorias" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>TI Consulting - Reporte de Tickets por Categorías</title>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            ...
                            <li class="active"><a href="wfReporteCategorias.aspx">Reporte por Categorías</a></li>
    ...
    <div class="container">
        ...
        <asp:UpdatePanel ID="UpdatePanel2" runat="server" ClientIDMode="Static">
            <ContentTemplate>
                <hr />
                <h2>
                    Reporte de Tickets por Categorías</h2>
                <hr />
                <div class="row">
                ...
                <div class="row">
                    <div class="col-xs-2">
                        <label>
                            Categoría de Problema</label></div>
                    <div class="col-xs-4">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <p />
                        <h2>
                            Total por Categoría de Problema</h2>
                        <hr />
                        <asp:GridView ID="gvResultadoCategoria" CssClass="table table-striped table-bordered table-condensed"
                            runat="server">
                        </asp:GridView>
                        <p />
                        <h2>
