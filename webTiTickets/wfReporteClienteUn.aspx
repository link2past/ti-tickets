<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfReporteClienteUn.aspx.cs"
    Inherits="webTiTickets.wfReporteClienteUn" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>TI Consulting - Reporte de Tickets por Cliente y Unidad de Negocio</title>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Reportes
                            <span class="caret"></span></a>
                        <ul class="dropdown-menu" role="menu">
                            <li class="active"><a href="wfReporteClienteUn.aspx">Reporte por Cliente y Unidad de Negocio</a></li>
    ...
    <div class="container">
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server" ClientIDMode="Static">
            <ContentTemplate>
                <hr />
                <h2>
                    Reporte de Tickets por Cliente y Unidad de Negocio</h2>
                <hr />
                <div class="row">
                        ...
                        <asp:GridView ID="gvExcel" runat="server" Visible="False" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Estado">
                                    <ItemTemplate>
                                        <asp:Label ID="lblEstadoE" runat="server" Text='<%#Eval("Ticket.EstadoTicket.Descripcion")%>'></asp:Label></div>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Categoria">
                                    <ItemTemplate>
                                        <asp:Label ID="lblCategoriaE" runat="server" Text='<%#Eval("Ticket.CategoriaProblema.Descripcion")%>'></asp:Label></div>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="Tarifa">
                                    <ItemTemplate>
                                        <asp:Label ID="lblTarifaE" runat="server" Text='<%#Eval("Tarifa")%>'></asp:Label></div>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Cantidad">
                                    <ItemTemplate>
                                        <asp:Label ID="lblCantidadE" runat="server" Text='<%#Eval("DetalleTicket.Cantidad")%>'></asp:Label></div>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Costo Unitario de Repuesto">
                                    <ItemTemplate>
                                        <asp:Label ID="lblCantidadE" runat="server" Text='<%#Eval("DetalleTicket.Precio")%>'></asp:Label></div>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Repuesto">
                                    <ItemTemplate>
                                        <asp:Label ID="lblRepuestoE" runat="server" Text='<%#Eval("DetalleTicket.Repuesto.Descripcion")%>'></asp:Label></div>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Total Repuestos">
                                    <ItemTemplate>
                                        <asp:Label ID="lblTotalRepuestosE" runat="server" Text='<%#Eval("TotalRepuestos")%>'></asp:Label></div>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Total General">
                                    <ItemTemplate>
                                        <asp:Label ID="lblTotalGeneralE" runat="server" Text='<%#Eval("TotalGeneral")%>'></asp:Label></div>
                                    </ItemTemplate>
                                </asp:TemplateField>
                ...
                <div class="container">
                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-3">
                                            <label>
                                                Unidad de Negocio</label></div>
                                        <div class="col-xs-3">
                                            <asp:Label ID="lblUnidadNegocio" runat="server" Text='<%#Eval("Ticket.Sede.UnidadNegocio.Descripcion")%>'></asp:Label></div>
                                        <div class="col-xs-3">
                                            <label>
                                                Sede</label></div>
                                        <div class="col-xs-3">
                        ...
                        <p />
                        <h2>
                            Total por Unidad de Negocio</h2>
                        <hr />
                        <asp:GridView ID="gvResultadoUnidad" CssClass="table table-striped table-bordered table-condensed"
                            runat="server">
                        </asp:GridView>
                        <p />
                        <h2>
