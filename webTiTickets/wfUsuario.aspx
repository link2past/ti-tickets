<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfUsuario.aspx.cs" Inherits="webTiTickets.wfUsuario" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>TI Consulting - Mantenimiento de Usuarios</title>
    ...
    <div class="container">
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server" ClientIDMode="Static">
            <ContentTemplate>
                ...
                <div class="container">
                    <div class="row">
                        <label class="col-xs-2" for="txtIdUsuario">
                            Usuario</label>
                        <div class="col-xs-4">
                    ...
                    <p />
                    <div class="row">
                        <label class="col-xs-2" for="txtContrasena">
                            Contraseña</label>
                        <div class="col-xs-4">
                            <asp:TextBox ID="txtContrasena" CssClass="form-control input-sm" runat="server" TextMode="Password"></asp:TextBox>
                        </div>
                    </div>
                    <p />
                    <div class="row">
                        <label class="col-xs-2" for="txtConfirmaContrasena">
                            Confirmar Contraseña</label>
                        <div class="col-xs-4">
                            <asp:TextBox ID="txtConfirmaContrasena" CssClass="form-control input-sm" runat="server"
                    ...
                    <p />
                    <div class="row">
                        <label class="col-xs-2" for="cboTipoUsuario">
                            Tipo de Usuario</label>
                        <div class="col-xs-4">
                            <asp:DropDownList ID="cboTipoUsuario" runat="server" CssClass="form-control dropdown input-sm">
                            </asp:DropDownList>
                        </div>
                    </div>
                    <p />
                    <div class="row">
                        <label class="col-xs-2" for="txtDiasCambio">
                            Días de Solicitud de Cambio de Clave</label>
                        <div class="col-xs-4">
                            <asp:TextBox ID="txtDiasCambio" CssClass="form-control input-sm" runat="server" TextMode="Number"></asp:TextBox>
                        </div>
                    </div>
                    <p />
                    <div class="row">
                        <label class="col-xs-2" for="chkRequiereCambio">
                            Requiere Cambio de Clave</label>
                        <div class="col-xs-4 checkbox">
                            <asp:CheckBox ID="chkRequiereCambio" runat="server" />
                        </div>
                    </div>
                    <p />
                    <div class="row">
